						...
						<table width="100%" clas="cent">
							<tbody>
                                ...
                                <tr class="cent">
									...
									<td width="23%"><input style="width:90%" type="text" name="acc[]" id="text" value="<?=$row['acc'];?>"></td>
									<td width="23%"><input style="width:90%" type="password" name="pw[]" id="pw" value="<?=$row['pw'];?>"></td>
