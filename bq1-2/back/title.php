						...
						<table width="100%">
							<tbody>
                                ...
                                <tr clas="cent">
									...
									<td width="7%"><input type="radio" name="sh" id="sh"<?=($row['sh']==1)?'checked':'';?> value="<?=$row['id']?>"></td>
									<td width="7%"><input type="checkbox" name="del[]" id="del" value="<?=$row['id']?>"></td>
									<td>
                                        <input type="button" value="更新圖片" onclick="op('#cover','#cvr','./modal/upload.php?table=<?=$do;?>&id=<?=$row['id'];?>')" value="更新照片">
                                    </td>
