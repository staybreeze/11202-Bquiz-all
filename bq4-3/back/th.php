<h2 class="ct">商品分類</h2>
<div class="ct">新增大分類<input type="text" name="big" id="big">
<input type="button" value="新增" onclick="addType('big')"></div>

<div class="ct">新增中分類

<select name="big" id="bigId">
<?php
...
<input type="button" value="新增" onclick="addType('mid')"></div>
...
<table class="all">
    ...
    ?>
    <tr>
        <td class="tt" style="width:70%"><?=$big['text'];?></td>
        <td class="tt ct">
            <input type="button" value="修改" onclick="edit(this,<?=$big['id'];?>)">

            <input type="button" value="刪除" onclick="location.href='./api/del_type?id='<?=$big['id'];?>">
        </td>
    </tr>
    <?php
    ...
    <tr>
        ...
        <td class="pp ct">
            ...
            <input type="button" value="刪除" onclick="location.href='./api/del_type?id='<?=$mid['id'];?>">
        </td>
    </tr>
    <?php
    }
...
<script>
    ...
    function addType(type){
        ...
        switch(type){
            case"big":
                ...
                $.post('./api/add_type.php',{big:big},(res)=>{
                    location.reload()
                    console.log(res)
                })
                break;
                case"mid":
                    $.post('./api/add_type.php',{mid:mid,big_id:bigId},(res)=>{
                    location.reload()
                })
                break;
        }
    ...
    function edit(dom,id){
       ...
       console.log(name)
       $.post('./api/edit_type.php',{text:name,id:id},(res)=>{
        location.reload()
        console.log(res)
       })
    }
