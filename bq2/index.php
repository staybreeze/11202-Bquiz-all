		...
		<div id="title2" title='健康促進網-回首頁'>
			...
			<div id="mm">
				...
				<div class="hal" id="main">
					<div>
						<marquee style="width:80%;display:inline-block">請民眾踴躍投稿電子報，讓電子爆成為大家相互交流、分享的園地!詳見最新文章</marquee>
						<span style="width:16%; display:inline-block;padding-bottom:2px">
<?php
						...
						?>
						<p>歡迎，<?=$_SESSION['user'];?>						<button onclick="location.href='./api/logout.php'">登出</button></p>
