...
<form action="./api/edit_admin.php" method="post">
    ...
    ?>
        ...
        <tr>
            ...
            <td class="pp"><input type="password" name="pw" id="pw" value="<?=str_repeat("*",strlen($row['pw']));?>"></td>
        </tr>
