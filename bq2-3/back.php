...
<body>
	...
	<div id="all">
		...
		<div id="title2"><a href="index.php
			">
				<img src="./img/02B01.jpg" alt="健康促進網-回首頁"></a>
		</div>
		...
		<div id="mm">
			...
			<div class="hal" id="main">
				<div>
					<marquee style="width:80%; display:inline-block;">1234</marquee>
					<span style="width:18%; display:inline-block;">
						...
						if (isset($_SESSION['user'])) {
							...
							if($_SESSION['user']=='admin'){
								echo "<br><button><a href='back.php'>管理</a></button>";
							}
